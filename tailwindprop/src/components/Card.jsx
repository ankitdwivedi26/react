...
function Card({companyName}){
  ...
  <div className="mx-auto max-w-7xl px-6 lg:px-8">
    <div className="mx-auto max-w-2xl lg:mx-0">
      <h2 className="text-5xl font-semibold tracking-tight text-white sm:text-7xl">Work with {companyName}</h2>
      <p className="mt-8 text-lg font-medium text-pretty text-gray-300 sm:text-xl/8">{companyName} is very good company.</p>
    </div>
